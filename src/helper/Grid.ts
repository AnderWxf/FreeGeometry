...
class Grid extends THREE.WireframeGeometry {
   ...
   * @param {number} [step0=5] - The big step of grid.
   * @param {number} [step1=1] - The small step of grid.
   * @param {number} [step2=0.1] - The tiny step of grid.
   */
  constructor(radius: number = 10, step0: number = 5, step1: number = 1, step2: number = 0.1, plane = "xz") {
    super();
    ...
    for (let i = min; i <= max; i += step2) {
      ...
      color.push(new THREE.Color(tcolor, tcolor, tcolor));
      color.push(new THREE.Color(tcolor, tcolor, tcolor));
      color.push(new THREE.Color(tcolor, tcolor, tcolor));
      color.push(new THREE.Color(tcolor, tcolor, tcolor));
