 ...
 */
class CreateCircle2ThreePointCom extends ComCreate {
  begin: Vector2;
  middle: Vector2;
  end: Vector2;
  ...
  onMouseMoveExec(event: MouseEvent) {
    ...
    if (this.begin && this.middle && !this.end) {
      ...
      // 创建一个临时曲线段
      let edge = Brep2Builder.BuildCircleFromBeginMiddleEndPoint(this.begin, this.middle, endPoint);
      if (edge == null) { return; }
      let t = BrepMeshBuilder.BuildEdge2Mesh(edge, THREE.Color.NAMES.gray, undefined, 0);
      t.name = "temp";
      this.tempResult = t;
...
export { CreateCircle2ThreePointCom };