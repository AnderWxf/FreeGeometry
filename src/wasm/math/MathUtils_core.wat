(module
  ...
  (func $toPeriod (export "toPeriod") (param $u f64) (param $period f64) (param $tol1 f64) (result f64)
    ...
    (local $__concat_self_len i32)
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 132) (i32.const 117))
          (i32.store8 (i32.const 133) (i32.const 58))
          (i32.store (i32.const 4) (i32.add (i32.const 2) (call $__f64_to_str (local.get $u) (i32.const 134))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 112))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 101))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 114))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 105))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 5))) (i32.const 111))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 6))) (i32.const 100))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 7))) (i32.const 58))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 8)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (local.get $period) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 0))) (i32.const 32))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 1))) (i32.const 116))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 2))) (i32.const 111))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 3))) (i32.const 108))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 4))) (i32.const 49))
          (i32.store8 (i32.add (i32.const 132) (i32.add (i32.load (i32.const 4)) (i32.const 5))) (i32.const 58))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 6)))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (call $__f64_to_str (local.get $tol1) (i32.add (i32.const 132) (i32.load (i32.const 4))))))
    ...
    (block $break_1
      (loop $loop_1
        ...
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 138) (i32.const 98))
          (i32.store8 (i32.const 139) (i32.const 115))
          (i32.store8 (i32.const 140) (i32.const 40))
          (i32.store8 (i32.const 141) (i32.const 117))
          (i32.store8 (i32.const 142) (i32.const 41))
          (i32.store8 (i32.const 143) (i32.const 58))
          (i32.store (i32.const 4) (i32.add (i32.const 12) (call $__f64_to_str (f64.abs (local.get $u)) (i32.const 144))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (call $__fd_write_all
            (i32.const 1)
    ...
    (local.set $d1 (f64.abs (local.get $u)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 17) (call $__f64_to_str (local.get $d1) (i32.const 149))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (call $__fd_write_all
            (i32.const 1)
    ...
    (local.set $d2 (f64.sub (local.get $u) (local.get $period)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 3) (call $__f64_to_str (local.get $d2) (i32.const 135))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (call $__fd_write_all
            (i32.const 1)
            ...
            (i32.const 1)
            (i32.const 128))
    (local.set $d2 (f64.abs (local.get $d2)))
        (i32.store (i32.const 0) (i32.const 132))
          (i32.store (i32.const 4) (i32.const 0))
          (i32.store8 (i32.const 132) (i32.const 77))
          (i32.store8 (i32.const 133) (i32.const 97))
          ...
          (i32.store (i32.const 4) (i32.add (i32.const 13) (call $__f64_to_str (local.get $d2) (i32.const 145))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (call $__fd_write_all
            (i32.const 1)
    ...
    (local.set $b2 (f64.le (local.get $d2) (local.get $tol1)))
        (i32.store (i32.const 0) (i32.const 132))
          ...
          (i32.store8 (i32.const 149) (i32.const 60))
          (i32.store8 (i32.const 150) (i32.const 61))
          (i32.store8 (i32.const 151) (i32.const 32))
          (i32.store8 (i32.const 152) (i32.const 116))
          (i32.store8 (i32.const 153) (i32.const 111))
          (i32.store8 (i32.const 154) (i32.const 108))
          (i32.store8 (i32.const 155) (i32.const 49))
          (i32.store8 (i32.const 156) (i32.const 58))
          (if (local.get $b2)
            (then
              (call $__str_gather (i32.const 275) (i32.const 4) (i32.const 157))
              (i32.store (i32.const 4) (i32.add (i32.const 25) (i32.const 4))))
            (else
              (call $__str_gather (i32.const 279) (i32.const 5) (i32.const 157))
              (i32.store (i32.const 4) (i32.add (i32.const 25) (i32.const 5)))))
          (i32.store8 (i32.add (i32.const 132) (i32.load (i32.const 4))) (i32.const 10))
          (i32.store (i32.const 4) (i32.add (i32.load (i32.const 4)) (i32.const 1)))
          (call $__fd_write_all
            (i32.const 1)
  ...
  (data (i32.const 260) "\74\6f\50\65\72\69\6f\64\20\62\65\67\69\6e\0a")
  (data (i32.const 275) "\74\72\75\65")
  (data (i32.const 279) "\66\61\6c\73\65")
  (data (i32.const 284) "\74\6f\50\65\72\69\6f\64\20\65\6e\64\0a")
)