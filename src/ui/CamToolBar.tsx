...
const grid_xz = new THREE.LineSegments(new Grid(100, 5, 1, 0.1, "xz"));
...
const grid_xy = new THREE.LineSegments(new Grid(100, 5, 1, 0.1, "xy"));
...
const grid_yz = new THREE.LineSegments(new Grid(100, 5, 1, 0.1, "yz"));
...
const ComOptionBar: React.FC = () => (
  <Space wrap>
    ...
    >录制</Checkbox>
    <div id='states' style={{ width: 300, position: 'fixed', fontSize: 14, top: 10, right: 360, color: '#00AA00', zIndex: 1000 }}> 光标位置 </div>
    {/* <Checkbox
...
const MenuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: CommandType.OTHER_UNDO, label: '撤销' + ' ' + CommandType.OTHER_UNDO + ' Ct + Z' },
      { key: CommandType.OTHER_REDO, label: '重做' + ' ' + CommandType.OTHER_REDO + ' Ct + Y' },
