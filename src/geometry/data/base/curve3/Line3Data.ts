...
class Line3Data extends Curve3Data {
   ...
   * @type {number}
   */
  private readonly type = GeomType.DATA_TYPE_CURVE3_LINE3;
  private readonly typename = GeomType[GeomType.DATA_TYPE_CURVE3_LINE3];
  /**
  ...
  /**
   * Returns a new Line3Data with clone values from this instance.
   *
   * @return {Line3Data} A clone of this instance.
   */
  override clone() {
    let result = super.clone() as Line3Data;
   ...
   *
   * @return {Line3Data} A copy of this instance.
   */
  override copy() {
