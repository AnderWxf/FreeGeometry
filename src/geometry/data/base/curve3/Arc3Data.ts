...
class Arc3Data extends Curve3Data {
   ...
   * @type {number}
   */
  private readonly type = GeomType.DATA_TYPE_CURVE3_ARC3;
  private readonly typename = GeomType[GeomType.DATA_TYPE_CURVE3_ARC3];
  /**
   ...
   *
   * @return {Arc3Data} a new instance.
   */
  static Unserialize(data: any): Arc3Data {
    let ret = new Arc3Data(Transform3.Unserialize(data.trans), Vector2.Unserialize(data.radius));
    ret.uuid = data.uuid;
    return ret;
  }
}
