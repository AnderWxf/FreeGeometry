...
/**
 * Plane surface algorithm.
 * u parameter is general parameters.
 * 
 */
class PlaneSurfaceAlgo extends SurfaceAlgo {
   ...
   */
  public dat: PlaneSurfaceData;

  /**
   * Constructs a surface algorithm.
   *
   * @param {PlaneSurfaceData} [dat = PlaneSurfaceData] - The data struct of this surface algorithm.
   */
  constructor(dat: PlaneSurfaceData) {
    super(dat);
    this.dat = dat;
  }
  ...
  p(uv: Vector2): Vector3 {
    let point = new Vector3(uv.x, uv.y, 0);
