...
/**
 * Ellipsoid surface algorithm.
 * u parameter is general parameters.
 * 
 */
class EllipsoidSurfaceAlgo extends SurfaceAlgo {

  /**
   * The data struct of this surface algorithm.
   *
   * @type {EllipsoidSurfaceData}
   */
  public dat: EllipsoidSurfaceData;

  /**
   * Constructs a surface algorithm.
   *
   * @param {EllipsoidSurfaceData} [dat = EllipsoidSurfaceData] - The data struct of this surface algorithm.
   */
  constructor(dat: EllipsoidSurfaceData) {
    super(dat);
    this.dat = dat;
  }
