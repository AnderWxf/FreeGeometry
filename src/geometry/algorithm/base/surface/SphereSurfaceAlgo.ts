...
/**
 * Sphere surface algorithm.
 * u parameter is general parameters.
 * 
 */
class SphereSurfaceAlgo extends SurfaceAlgo {

  /**
   * The data struct of this surface algorithm.
   *
   * @type {SphereSurfaceData}
   */
  public dat: SphereSurfaceData;

  /**
   * Constructs a surface algorithm.
   *
   * @param {SphereSurfaceData} [dat = SphereSurfaceData] - The data struct of this surface algorithm.
   */
  constructor(dat: SphereSurfaceData) {
    super(dat);
    this.dat = dat;
  }
