...
/**
 * Nurbs surface algorithm.
 * u parameter is general parameters.
 * 
 */
class NurbsSurfaceAlgo extends SurfaceAlgo {
   ...
   */
  public dat: NurbsSurfaceData;

  /**
   * Constructs a surface algorithm.
   *
   * @param {NurbsSurfaceData} [dat = NurbsSurfaceData] - The data struct of this surface algorithm.
   */
  constructor(dat: NurbsSurfaceData) {
    super(dat);
    this.dat = dat;
  }
